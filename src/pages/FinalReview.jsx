  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center justify-center py-20 overflow-hidden">
      ...
      <div className="relative w-[700px] h-[700px]">
        ...
        {/* Glowing Table Background */}
        <div className="absolute inset-0 rounded-full bg-[#1e293b] shadow-[0_0_150px_rgba(212,175,55,0.25)]"></div>
        ...
        {main && (
          ...
          >
            <div className="w-44 h-44 rounded-full bg-yellow-500 text-black flex items-center justify-center text-lg font-bold shadow-2xl animate-pulse">
              {main.title}
            </div>
          </div>
        )}
